...
const CrimeMap = ({ data = [] }) => {
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      <div style={{ position: "absolute", top: "10px", right: "10px", background: "rgba(255, 255, 255, 0.9)", padding: "10px", borderRadius: "5px", zIndex: 1500, display: "flex", flexDirection: "column" }}>
        <h3>Filters</h3>
        <label>Year:</label>
      ...
      {/* Map Section */}
      <MapContainer center={[41.8781, -87.6298]} zoom={11} style={{ height: "500px", width: "100%" }}>
